...
description: Start, enable, compare, and smoke test Dynamo router modes, especially round-robin versus KV-aware routing. Use when a user wants to make the router easy to try, patch a recipe to use the router, or prove that a router-backed endpoint is healthy.
---
