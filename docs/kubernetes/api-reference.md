...
| `image` _string_ | Image is the container image for the DGDR profiling job.<br />For current releases, use "nvcr.io/nvidia/ai-dynamo/dynamo-planner:DYNAMO_VERSION". |  | Optional: \{\} <br /> |
